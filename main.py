...
print(connections.get_g_metrix("IP 1", "IP 6"))
print(connections.get_metrics_matrix())

editable_params: EditableParams = EditableParams(1, 1, 0.5, 10, 20, 0.1)

calculator: Calculator = Calculator(editable_params, connections.get_g_metrix("IP 1", "IP 6"), connections.get_metrics_matrix())
